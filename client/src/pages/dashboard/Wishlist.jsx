  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 pb-24 md:pb-8 px-4 md:px-0 font-inter">
      ...
      <div className="flex items-center mb-6 mt-2 md:hidden">
        ...
        <h1 className="text-xl font-bold text-brand-700">My Wishlist</h1>
      </div>
      ...
      {loading ? (
            ...
            return (
              ...
              >
                ...
                <div className="relative h-48 w-full bg-gray-100 overflow-hidden">
                  ...
                  />
                  <div className="absolute top-3 left-3 bg-brand-700/80 backdrop-blur-md text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                ...
                <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                  <div>
                    <div className="flex items-center justify-between text-xs font-semibold text-gray-500 mb-2">
                      <span className="text-brand-600 font-bold uppercase">{course.level || 'Beginner'}</span>
                      <span>{course.accessValidity || '2 Months'} Access</span>
                    </div>
                    <h3 className="font-bold text-gray-900 text-lg line-clamp-2 hover:text-brand-600 transition-colors">
                  ...
                  <div className="pt-4 border-t border-gray-100 flex items-center justify-between">
                    ...
                    {isEnrolled ? (
                      <button
                        ...
                        className="px-4 py-2.5 bg-brand-600/10 text-brand-700 hover:bg-brand-600 hover:text-white font-bold rounded-xl text-xs flex items-center gap-1.5 transition-all"
                      >
                      ...
                      <button
                        ...
                        className="px-5 py-2.5 bg-brand-600 hover:bg-brand-700 text-white font-bold rounded-xl text-xs flex items-center gap-2 transition-all shadow-[0_4px_12px_rgba(41,120,56,0.25)]"
                      >
        ...
        <div className="text-center py-20 bg-white rounded-3xl border border-gray-100 shadow-sm p-8 max-w-lg mx-auto">
          ...
          <p className="text-gray-500 mb-8 text-sm">Explore our catalog of authentic Java, Python, DevOps, and Cloud Computing courses and bookmark your favorites!</p>
          <button
            onClick={() => navigate('/courses')}
            className="px-8 py-3.5 bg-brand-600 hover:bg-brand-700 text-white font-bold rounded-2xl transition-all shadow-[0_4px_14px_rgba(41,120,56,0.3)] inline-flex items-center gap-2"
          >
