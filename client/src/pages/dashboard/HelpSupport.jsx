    ...
    <div className="max-w-5xl mx-auto space-y-8 pb-24 md:pb-12 px-4 md:px-0 font-inter">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <a
          ...
          className="bg-blue-600/10 hover:bg-blue-600/20 border border-blue-500/30 p-6 rounded-3xl flex flex-col items-center text-center transition-all group shadow-sm"
        >
          <div className="w-14 h-14 bg-blue-600 text-white rounded-2xl flex items-center justify-center text-2xl mb-3 shadow-md group-hover:scale-110 transition-transform">
            <FaEnvelope />
          </div>
