  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 pb-24 md:pb-8 px-4 md:px-0 font-inter">
      ...
      <div className="flex items-center mb-6 mt-2 md:hidden">
        ...
        <h1 className="text-xl font-bold text-brand-700">Payment History</h1>
      </div>
                  ...
                  <tr key={record._id} className="hover:bg-gray-50/60 transition-colors">
                    <td className="p-5 pl-6">
                      <div className="flex items-center gap-3">
                        <div className="w-11 h-11 rounded-2xl bg-brand-600/10 text-brand-600 flex items-center justify-center shrink-0">
                    ...
                    <td className="p-5">
                      <span className="flex items-center gap-1.5 text-xs font-bold text-green-700 bg-indigo-100/80 px-3 py-1 rounded-full w-max uppercase tracking-wide">
                    ...
                    <td className="p-5 pr-6 text-right">
                      <button 
                        ...
                        className="px-3.5 py-2 bg-brand-600/10 hover:bg-brand-600 hover:text-white text-brand-700 font-bold text-xs rounded-xl transition-all inline-flex items-center gap-1.5"
                      >
              ...
              <div className="p-6 md:p-8 space-y-6 text-gray-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-bold text-brand-700 text-right max-w-xs">{selectedReceipt.course?.title}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    onClick={handlePrint}
                    className="flex-1 py-3 bg-brand-600 hover:bg-brand-700 text-white font-bold rounded-xl text-sm flex items-center justify-center gap-2 transition-all shadow-md"
                  >
